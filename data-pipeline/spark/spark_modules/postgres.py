...
class PostgresConnector:
    ...
    def load_config(self, spark_config_name="postgres", db_config_name="server_postgres"):
    ...
    def init_spark(self, app_name="PostgresConnector"):
        """Initialize Spark with PostgreSQL support."""
    ...
    def write_to_table(self, df, table_name, mode="overwrite"):
        ...
        try:
            ...
            print(">>> [Success] Data successfully loaded to PostgreSQL!")
        except Exception as e:
    ...
    def table_exists(self, table_name):
        ...
        try:
            ...
            self.exec_sql(f"SELECT 1 FROM {table_name} LIMIT 0")
