...
class OracleConnector:
    ...
    def load_config(self, spark_config_name="oracle", db_config_name="server_oracle"):
    ...
    def init_spark(self, app_name="OracleConnector"):
        """Initialize Spark with Oracle support."""
    ...
    def write_to_table(self, df, table_name, mode="overwrite"):
        ...
        try:
            ...
            print(">>> [Success] Data successfully loaded to Oracle!")
        except Exception as e:
    ...
    def table_exists(self, table_name):
        ...
        try:
            ...
            # Oracle prefers WHERE ROWNUM <= 0 or similar, but Spark JDBC might wrap it.
            # Plain "LIMIT 0" is not valid Oracle SQL. ROWNUM <= 0 is better.
            # But let's see if generic Spark approach works or if we need dialect check.
            # Since 'exec_sql' just wraps it in (), sending "SELECT 1 FROM table LIMIT 0" to Oracle fails.
            # Sending "SELECT 1 FROM table WHERE 1=0" is safer cross-db. 
            # In postgres I used "LIMIT 0".
            # For Oracle, let's use "WHERE 1=0".
            
            self.exec_sql(f"SELECT 1 FROM {table_name} WHERE 1=0")
    ...
    def check_db_connection(self):
        ...
        try:
            ...
            # Oracle requires FROM DUAL for SELECT 1
            self.exec_sql("SELECT 1 FROM DUAL")
